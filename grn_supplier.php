            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-cart-arrow-down"></i> GRN <small>Receive By Supplier</small> <span class="badge badge-dark">Step 1</span> <small>Create GRN </small>  &nbsp;&nbsp;<button class="btn btn-light d-print-none" onclick="goDashboard();"><i class="fas fa-chevron-circle-left"></i>&nbsp;Back</button></h4>                       
                    </div>
                </div>
...
//				1 = supplier , 2 = institute
				...
				var grn_supplier = $('.cmbSupplier').val();
				var postdata = {
					action: "saveGrnSupplier",
					grn_type: grn_type,
				...
				$.post('controllers/grnController.php', postdata, function (e) {
					if (parseInt(e.msgType) == 1) {
						...
						setTimeout(function () {
							window.location.href = 'grnSupplierItem.php?grn_id=' + e.grn_id;
						}, 2300);
						clearIssue();
					} else {
			...
			$(document).ready(function () {
				...
				cmbSupplier(false,function(dataAvailable){
					//check issuing availability.for validate data entry part                         
					if (parseInt(dataAvailable) == 0) {
						var controlMsg = '<div class="alert bg-warning"><strong>NOTE</strong> GRN Creation restricted! becasue of Supplier not available.</div>';
