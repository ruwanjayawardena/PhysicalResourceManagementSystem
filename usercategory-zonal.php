...
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-user-circle"></i> User Category &nbsp;&nbsp;<button class="btn btn-light d-print-none" onclick="window.history.back(-1);"><i class="fas fa-chevron-circle-left"></i>&nbsp;Back</button></h4>                       
                    </div>
                </div>
                <div class="row">
	...
	?>  
    <script>
		function loadLoggedUserInfo() {
			$.post('controllers/userController.php', {action: 'loggedUsersInfo'}, function (info) {
				$.each(info, function (info_index, info_qdt) {
					$('#zol_id').html('').append(info_qdt.zol_id)
					var inst_zonal = info_qdt.zol_id;
		...
		function tblUserCategory(usrcat_institute, callback) {
			...
			$.post('controllers/userCategoryController.php', {action: 'getAllUserCategory', usrcat_institute: usrcat_institute}, function (e) {
				...
				$('.btn-assignprvg').click(function () {
					...
					window.location.href = "assignprivilege_institute.php?usrcat_id=" + usrcat_id;
				});
