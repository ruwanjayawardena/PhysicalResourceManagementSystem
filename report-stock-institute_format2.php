...
<html lang="en">
    ...
    <script>
		function tblMainStock(callback) {
			...
			var tbldata = "";
			$.post('controllers/mainStockController.php', {action: 'getAllMainStockFormat2'}, function (e) {
